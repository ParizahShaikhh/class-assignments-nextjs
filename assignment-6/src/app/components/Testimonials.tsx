...
const Testimonials = () => {
    return (
        <div className='w-full bg-[#F7F7F7] py-8 px-4'>
            <h1 className='text-[32px] md:text-[48px] font-bold text-black mt-4'>What Our Student Say</h1>
            <p className='text-[18px] mb-8'>Lorem ipsum dolor sit amet, consectetur adipiscing elit.</p>
            <div className='flex overflow-x-scroll sm:overflow-hidden gap-8 py-4'>
                <div className='w-[362.67px] p-6 border border-black bg-[#F7F7F7] flex-none'>
                    <div className='flex gap-1'>
                        <span className='text-black text-3xl'>★</span><span className='text-black text-3xl'>★</span><span className='text-black text-3xl'>★</span><span className='text-black text-3xl'>★</span>
                    </div>
                    <div className='mt-4'>
                    ...
                    <div className='mt-4 flex items-center gap-4'>
                        <img src="" alt="team" className='w-16 h-16 rounded-full object-cover' />
                        <div>
