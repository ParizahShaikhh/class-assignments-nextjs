...
const Hero: React.FC = () => {
    return  (
        ...
        <h1 className="text-4xl font-bold justify-center flex reveal-text">Hey!! I am <span>P</span><span>a</span><span>r</span><span>i</span><span>z</span><span>a</span><span>h</span> <span>S</span><span>h</span><span>a</span><span>i</span><span>k</span><span>h</span></h1>
